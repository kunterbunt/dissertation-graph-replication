...
writematrix(expectation_mats_mdl, 'data/expectation_mats_model_16ppps.csv');
disp(['Saved data to data/expectation_mats_model_16ppps.csv']);
writematrix(expectation_mats_sim, 'data/expectation_mats_sim_16ppps.csv');
disp(['Saved data to data/expectation_mats_sim_16ppps.csv']);
